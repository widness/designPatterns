...
import lab.command.onBoard.commands.*;
import lab.command.onBoard.invoker.OnBoardSystem;
import lab.command.onBoard.receiver.*;
...
public class OnBoardSystemLoader {
    ...
    public static void main(String[] args) {
        ...
        OnBoardSystem onBoardSystem = OnBoardSystemLoader.setupOnBoardSystem();
        OnBoardSystemLoader.test(onBoardSystem);
    }

    public static void test(OnBoardSystem onBoardSystem) {
    ...
    public static OnBoardSystem setupOnBoardSystem() {
